    ...
    public class Overlay : IDisposable
    {
        ...
        private void _window_DrawGraphics(object sender, DrawGraphicsEventArgs e)
        {
            ...
            for (int i = 0; i < maxPlayer; i++)
            {
                ...
                //if (!IsNullVector2(v2Bone0))
                //{
                //    gfx.DrawCircle(_brushes["red"], v2Bone0.X, v2Bone0.Y, 5, 1);
                //}
                ...
                //Vector2 v2Bone1 = WorldToScreen(GetBonePosition(entity, 2));
                //Vector2 v2Bone0 = WorldToScreen(GetBonePosition(entity, 1));
                ...
                //DrawBone(gfx, 8, 7, entity);

                //DrawBone(gfx, 7, 40, entity);
                //DrawBone(gfx, 40, 41, entity);

                //DrawBone(gfx, 7, 12, entity);
                //DrawBone(gfx, 12, 13, entity);

                //DrawBone(gfx, 7, 6, entity);
                //DrawBone(gfx, 6, 4, entity);
                //DrawBone(gfx, 4, 3, entity);

                //DrawBone(gfx, 3, 74, entity);
                //DrawBone(gfx, 74, 75, entity);

                //DrawBone(gfx, 3, 67, entity);
                //DrawBone(gfx, 67, 68, entity);
            }
        }
